...
// Updated renderMembers function to pass member data to edit buttons
...
// Updated handleEditButtonClick function to accept member data
...
// Add cancel functionality for edit form
function cancelEdit() {
...
function handleEditButtonClick(event) {
  ...
  const memberData = JSON.parse(button.getAttribute('data-member').replace(/&apos;/g, "'"));

  // Show the edit form page
  showEditMemberForm(event);

  // Populate form fields
  document.getElementById('member-firstName').value = memberData.firstname || '';
  document.getElementById('member-lastName').value = memberData.lastname || '';
  document.getElementById('member-username').value = memberData.username || '';
  document.getElementById('member-email').value = memberData.email || '';
  document.getElementById('member-password').value = ''; // Clear password for security
  document.getElementById('member-repassword').value = '';
  document.getElementById('member-phonenumber').value = memberData.phonenumber || '';
