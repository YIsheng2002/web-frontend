...
function filterByStatus(status) {
    ...
    switch (status) {
        case 'olderst-member':
            console.log("Filtering by oldest member...");
            break;
        case 'newest-member':
            console.log("Filtering by newest member...");
            break;
        case 'highest-total-order':
            console.log("Filtering by highest total orders...");
            break;
        case 'lowest-total-order':
            console.log("Filtering by lowest total orders...");
            break;
        default:
