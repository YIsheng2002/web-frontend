...
function handleAddMember() {
  ...
  const repassword = document.getElementById('member-repassword').value;
  const phoneNumber = document.getElementById('member-phoneNumber').value;   
  const gender = document.getElementById('memberGender').value;
  const runnerType = document.getElementById('member-runnerType').value;  
