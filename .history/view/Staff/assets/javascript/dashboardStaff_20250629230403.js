...
//  cancel functionality for edit form
function cancelEdit() {
  if (confirm('Are you sure you want to cancel? Any unsaved changes will be lost.')) {
    // Hide edit form and show main dashboard (Membership list)
    showMembership(new Event('click'));

    // Optional: clear the form fields in case it's revisited later
    const editForm = document.getElementById('editMemberForm');
    if (editForm) editForm.reset();

    // Optional: hide runner type field (in case it was previously shown)
